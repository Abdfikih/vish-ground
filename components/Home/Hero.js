...
export default function Hero() {
  return (
    <div className="flex flex-col md:flex-1 md:grid md:grid-cols-2 gap-8 pt-4 md:pt-10 pb-16 px-4 md:px-8 text-white min-h-full">
      <div className="flex flex-col justify-center items-center md:items-start">
        ...
        <div className="flex mt-4">
          <button onClick={() => (document.location.href = "https://abdfikih.site")} className="flex items-center px-4 h-10 rounded-lg bg-blue-500 text-white hover:bg-blue-700 focus:outline-none">
            <p className="ml-2 uppercase text-sm font-medium tracking-wide">DOCUMENTATION</p>
          </button>
          <button onClick={() => (document.location.href = "https://abdfikih.site")} className="flex items-center ml-4 px-4 h-10 rounded-lg bg-blue-500 text-white hover:bg-blue-700 focus:outline-none">
