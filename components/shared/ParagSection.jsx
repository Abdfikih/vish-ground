...
const ParagSection = ({ keyword1, paragraph1, keyword2, paragraph2, img, reverse, redirect }) => {
  return (
    <div className="flex flex-col gap-10 items-center lg:flex-row">
      ...
      <div className={`relative w-[250px] h-[250px] lg:w-[321px] 2xl:w-[480px]  lg:h-[321px]  2xl:h-[480px] ${reverse && "lg:order-first"}`}>
