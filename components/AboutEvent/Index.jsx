        ...
        <div className="gap-8 row-2 lg:columns-2 mt-[50px]">
          ...
          <div className="gap-8 rows-2 p-4 sm:p-10">
            <p className="text-xl 2xl:text-3xl lg:text-2xl">
              <b>KRTI (Kontes Robot Terbang Indonesia)</b> is a competition held in Indonesia to promote innovation and technological advancements in the field of unmanned aerial vehicles (UAVs) or drones. Participants in this competition
              design, build, and operate flying robots to complete specific tasks.
            </p>
            <div className="gap-4 columns-2 2xl:text-4xl lg:text-3xl text-xl font-bold mt-[15px] pr-2">
              <div className="flex-row">
                ...
                <p className="2xl:text-4xl lg:text-3xl sm:text-xl text-base">In Indonesia and UAVs Area</p>
              </div>
              <div className="flex items-start gap-2 ">
                <p className="2xl:text-7xl lg:text-6xl text-2xl">+5</p>
                <p className="2xl:text-4xl lg:text-3xl sm:text-xl text-base mt-[25px]">Fields Competitions</p>
              </div>
            </div>
          </div>
        </div>
